...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <div>
            <h2 class="main-content-title fs-24 mb-1">Biodata</h2>
    ...
    <div class="row row-sm">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="exampleModalLabel1">Tambah Peserta</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="{{route('dashboard.biodata.insert')}}" id="formreg"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-12 mb-1">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" style="background-color:#fafafa;"
                                            id="email" name="email"
                                            placeholder="Email " required=""
                                            value="{{ old('email') }}">
                                        <label class="label-form" for="email">Email
                                            *</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-1">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" style="background-color:#fafafa;"
                                            ...
                                            value="{{ old('phone') }}">
                                        <label class="label-form" for="phone">Phone
                                            *</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-1">
                                    <div class="form-floating">
                                        ...
                                        <label class="label-form" for="phone">Alamat *</label>
                                    </div>
                                </div>
                            </div>
                    </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="editModalLabel1">Edit Peserta</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
...
@push('script')
    ...
    <script>
        ...
        $('#responsiveDataTable').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url(path: 'dashboard/biodata/edit') }}/" + id,
                type: 'GET',
                data: {
                    id: id
                },
                success: function(biodata) {
                    ...
                    $('#email_edit').val(biodata.email);
                    $('#phone_edit').val(biodata.phone);
        ...
        $('#formedit').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ url('dashboard/biodata/update') }}",
                type: 'POST',
                data: formData,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $('#responsiveDataTable').on('click', '.btn-hapus', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('dashboard/biodata/delete') }}/" + id,
                        type: 'DELETE',
                        data: {
