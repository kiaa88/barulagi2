            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{route('dashboard.kategori.insert')}}" id="formKategori"
                                ...
                                <div class="col-lg-12 mb-1">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" style="background-color:#fafafa;"
                                            id="nama" name="nama" placeholder="Input nama kategori" required=""
                                            value="{{ old('nama') }}">
                        ...
                        <form method="POST" action="" id="formedit"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-12 mb-1">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" style="background-color:#fafafa;"
                                            id="nama_edit" name="nama" placeholder="Input nama kategori" required=""
        ...
        $('#responsiveDataTable').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                ...
                success: function(kategori) {
                    ...
                    $('#id_edit').val(kategori.id);
                    $('#nama_edit').val(kategori.nama);
                    $('#deskripsi_edit').val(kategori.deskripsi);
                },
                error: function(xhr, status, error) {
                    $.unblockUI();
                    console.error('Error:', error);
